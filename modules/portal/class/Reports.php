<?php
/**
 * Class responsável por todo o fluxo de operações de relatórios
 * do módulo Portal de Anuncios sendo dados unitários
 * @copyright Felipe Oliveira 02.02.2023
 * @version 1.0.0
 */
...
class Reports
{
    private $table = TB_PORTAL_REPORTS;
    ...
    public function sendForm(array $infos, int $account_id)
    {
        ...
        if ($this->checkStrKey('email') && $this->checkStrKey('name')) {
            ...
            return [
                ...
                'message' => ($Send)? 'Contato enviado por e-mail com sucesso' : 'Não foi possível enviar e-mail',
