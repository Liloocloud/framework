<div class="uk-flex uk-flex-between uk-flex-middle uk-margin-bottom">
    <div><h1>Gerenciamento de Clientes - <small>Módulo Nativo</small></h1></div>
    <div><a href="#BASE_ADMIN#clients/reports/" class="uk-button uk-button-primary uk-button-small"><i class="far fa-chart-bar"></i> Relatório</a></div>
</div>
        ...
        <div class="uk-card uk-card-default">
            <div class="uk-card-header uk-padding-small">
                <div class="uk-flex uk-flex-between uk-flex-middle">
                    ...
                    <div>
                        <a id="btn-create-client" href="#modal-create-client" type="button" class="uk-button uk-button-primary uk-button-small" uk-toggle><i class="fas fa-plus"></i> Novo Cliente</a>
                    </div>
                </div>
            </div>
...
<div id="modal-create-client" class="uk-modal-full" tabindex="0" uk-modal style="background: #0000004d;">
    ...
    <div class="uk-modal-dialog uk-animation-slide-right uk-padding liloo-h100" style="background: #EAEFF6">
        <h2>Novo Cliente <br><br></h2>                          
        
        <div class="uk-grid-small" uk-grid>
            <div class="uk-width-expand@m">
                <div class="uk-card uk-card-default uk-padding-small">
                    <liloo-form id="create-client"></liloo-form>
                </div>
            </div>
