<div>
    <!-- CARD -->
    <div class="uk-card uk-card-default uk-card-hover uk-padding-small" onclick="modalChannelData('#faa')">
        <div class="uk-flex uk-flex-between uk-padding-remove">
            <img src="#BASE_THEME_UPLOADS#icons/facebook-ads.svg" alt="#title#" width="55px">
            <div class="uk-text-large"><span class="uk-text-large #interactions#"><div uk-spinner></div></span></div>
        </div>
        <div class="uk-grid-small uk-flex-middle uk-margin-small-top" uk-grid>         
            <div class="uk-width-expand">
                <h5 class="uk-margin-remove-bottom">#title#</h5>
                <p class="uk-margin-remove-top uk-text-xsmall">#desc#</p>
            </div> 
        </div>
    </div>

    <!-- MODAL -->
    <div id="faa" class="uk-modal-full" tabindex="0" uk-modal style="background: #0000004d;">
                ...
                <div>
                    <div class="uk-card uk-card-default">
                        ...
                        <div class="uk-card-body uk-text-center liloo-funil">
                            <div style="background: #12B199; width: 100%"><span class="uk-text-small">Sessões</span> <b>1234</b></div> 
                            <div style="background: #8CC64B; width: 90%;"><span class="uk-text-small">Interações</span> <b>598</b></div> 
                            <div style="background: #D8CF2A; width: 80%;"><span class="uk-text-small">Conversão</span> <b>258</b></div> 
                            <div style="background: #F5822C; width: 70%;"><span class="uk-text-small">Interesse</span> <b>58</b></div>
                            <div style="background: #CC2331; width: 60%;"><span class="uk-text-small">Vendas</span> <b>2</b></div> 
                        </div>
                    </div>
                </div>
                    ...
                    <div class="uk-child-width-1-2@m uk-grid-small uk-grid-match" uk-grid>
                            ...
                            <div class="uk-card uk-card-default uk-padding-small">
                                ...
                                <div class="uk-grid-small uk-flex-middle uk-margin-small-top" uk-grid>
                                    <div class="uk-width-expand">
                                        ...
                                        <p class="uk-margin-remove-top uk-text-xsmall">Ações e interações de contatos realizadas no site</p>
                                    </div>
                                </div>
                            </div>
                        </div>    
                        ...
                        <div>
                            <div class="uk-card uk-card-default uk-padding-small">
                                <div class="uk-flex uk-flex-between uk-padding-remove">
                                    ...
                                    <div class="uk-text-large"><span class="uk-text-large #session#"><div uk-spinner></div></span></div>
                                </div>
                                <div class="uk-grid-small uk-flex-middle uk-margin-small-top" uk-grid>
                                    <div class="uk-width-expand">
                                        <h5 class="uk-margin-remove-bottom">Interações</h5>
                        ...
                        <div>
                            <div class="uk-card uk-card-default uk-padding-small">
                                ...
                                <div class="uk-flex uk-flex-between uk-padding-remove">
                                    <img src="<?= BASE_UPLOADS ?>icons/click-button-whatsapp.svg" alt="Whatsapp" width="45px">
                                    <div>
                                        <div class="uk-inline">
                                            <a href="" class="uk-icon-button" uk-icon="info"></a>
                                            <div uk-drop="mode: click; pos: top-right;">
                                                <div class="uk-card uk-card-body uk-card-default uk-padding-small uk-text-small">Todas as interações vindas de links que você utilizou na rede social do facebook. Essa métrica só será precisa se você utilizar o links de acompanhamento.</div>
                                            </div>
                                        </div>
                                        <div class="uk-inline">
                                ...
                                <div class="uk-grid-small uk-flex-middle uk-margin-small-top" uk-grid>
                                    <div class="uk-width-expand">
                                        ...
                                        ?>
                                        <h4 class="uk-margin-remove-bottom">Cliques: <?= $Extra['contacts_clicks'] ?></h4>
                                        <p class="uk-margin-remove-top uk-text-small">Usuários que clicaram no botão do Whatsapp</p>
                            ...
                            <div class="uk-card uk-card-default uk-padding-small">
                                ...
                                <div class="uk-grid-small uk-flex-middle uk-margin-small-top" uk-grid>
                                    <div class="uk-width-expand">
                                        ...
                                        ?>
                                        <h4 class="uk-margin-remove-bottom">Whatsapp: <?= $Extra['contacts_whatsapp'] ?></h4>
                                        <p class="uk-margin-remove-top uk-text-small">Usuários que iniciaram uma conversa pelo Whatsapp</p>
                                        <!-- <a href="#" class="uk-button uk-button-primary uk-width-1-1">Lista completa</a> -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="uk-card uk-card-default uk-padding-small">
                                <img src="<?= BASE_UPLOADS ?>icons/unlock-phone.svg" alt="Visualização no Telefone" width="25px">
                                <div class="uk-grid-small uk-flex-middle uk-margin-small-top" uk-grid>
                                    <div class="uk-width-expand">
                                        <?php
                                        ...
                                        ?>
                                        <h4 class="uk-margin-remove-bottom">Telefone: <?= $Extra['contacts_phone'] ?></h4>
                                        <p class="uk-margin-remove-top uk-text-small">Usuários que clicaram para ver o telefone</p>
                                        <!-- <a href="#" class="uk-button uk-button-primary uk-width-1-1">Lista completa</a> -->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="uk-card uk-card-default uk-padding-small">
                                ...
                                <div class="uk-grid-small uk-flex-middle uk-margin-small-top" uk-grid>
                                    <div class="uk-width-expand">
                                        ...
                                        ?>
                                        <h4 class="uk-margin-remove-bottom">Formulário: <?= $Extra['contacts_form'] ?></h4>
                                        <p class="uk-margin-remove-top uk-text-small">Usuários que preencheram o formulário</p>
                                        <!-- <a href="#" class="uk-button uk-button-primary uk-width-1-1">Lista completa</a> -->
                                    </div>
                                </div>
                            </div>
