                            ...
                            <li id="${props.prod_id}">
                                <div class="uk-grid-small" uk-grid>
                                    ...
                                    <div class="uk-width-1-3@m">
                                        ...
                                        <p><a href="${lilooV3.Root()}admin/shop/edit/?id=${props.prod_id}" class="uk-button uk-button-primary uk-button-xsmall uk-margin-top">Editar</a></p>
                                    </div>
                                </div>
                            </li>
                        `)
                ...
                lilooForms({
                    ...
                    build: [
                        ...
                        
                        {
                            ...
                            value: props.prod_price
                        },

                        {
                            el: 'input',
                            name: 'prod_price_promotional',
                            label: 'Preço Promocional em R$',
                            parentClass: 'uk-width-1-4@m',
                            attr: 'liloo-mask-real',
                            value: props.prod_price_promotional
                        },

                        {
                            ...
                            items: [
                                { 
                                    text: 'Sim', 
                                    value:'Sim estamos aqui', 
                                    attr: (props.prod_price_show == 1)? 'checked' : ''
                                },
                                { 
                                    text: 'Não', 
                                    value:'Não estamos aqui',
                                    attr: (props.prod_price_show == 0)? 'checked' : ''
                                }
                            ],
                        },
...
// Renderiza o form de novo produto
lilooForms({
    ...
    success: function () {
        UIkit.modal('#modal-create-product').hide()
        document.querySelector('#create-product form').reset()
        loadSearchList()
    },
})

// Inclue foco no input e reseta o form após clicar em nova produto
$('#btn-create-product').on('click', function () {
    setTimeout(function () {
        $('#create-product input[name="prod_code"]').focus()
        // loadLastCreate()
    }, 500)
})
