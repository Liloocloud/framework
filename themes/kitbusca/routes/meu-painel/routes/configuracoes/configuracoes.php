<?php
/**
 * Área interna de configurações da conta de usuário
 * @copyright Felipe Oliveira Lourenço - 21.05.2020
 */
$Account = new Companies($_SESSION['account_id']);
if($Account->checkCompany()[1]){
	...
	_tpl_fill($PATH_DASH.'routes/configuracoes/configuracoes.tpl', $Extra, '');

}else{
	__redirectURL('login/', true);
}